...
sendVarToJS('eqType', 'rpict');
sendVarToJs('object_id', init('object_id'));
$eqLogics = eqLogic::byType('rpict');

?>

<div class="row row-overflow" id="div_rpict">
	<div class="row">
		<div class="col-lg-12">
			...
			<a class="btn btn-default pull-right tooltips" style="margin-right:15px"  id="bt_rpictPanelSante" title="{{Vérifier l'intégrité des données}}"><i class="fa fa-check-circle-o"></i>{{ Vérifier }}</a>
		</div>
				...
				<fieldset>
					...
					<div class="form-group col-md-4" style="left:5px;">
						...
						<div class="text-center">
							<span class='label label-success' style="font-size: 1.3em;">
								<span class="rpictAttr" data-l1key="conso" data-l2key="day"></span>
								kWh
							</span>
						</div>
					</div>
					<div class="form-group col-md-4">
						<div class="text-center">
							...
							<span class='label label-success' style="font-size: 1.3em;">
								<span class="rpictAttr" data-l1key="conso" data-l2key="month"></span>
								kWh
							</span>
						</div>
                    <!--</br>
					...
					<div class="form-group col-md-4">
						<div class="text-center">
							...
							<span class='label label-success' style="font-size: 1.3em;">
								<span class="rpictAttr" data-l1key="conso" data-l2key="year"></span>
								kWh
							</span>
						</div>
					</div>
            ...
            <form class="form-horizontal">
                <fieldset >
                    ...
                    <div class="form-group col-md-4" style="left:5px;">
						...
						<div class="text-center">
                            <span class='label label-default' style="font-size: 1.3em;">
                                <span class="rpictAttr" data-l1key="conso" data-l2key="monthlastyear"></span>
                                kWh
                            </span>
						</div>
					</div>
                    <div class="form-group col-md-4" style="left:5px;">
						...
						<div class="text-center">
                            <span class='label label-default' style="font-size: 1.3em;">
                                <span class="rpictAttr" data-l1key="conso" data-l2key="yearlastyear"></span>
                                kWh
                            </span>
						</div>
					</div>
...
<?php include_file('desktop', 'panel', 'js', 'rpict'); ?>
