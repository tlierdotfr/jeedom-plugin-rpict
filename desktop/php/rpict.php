...
switch ($controlerState) {
	case 'ok':
		...
		break;
	case 'nok':
		if (config::byKey('deamonAutoMode', 'rpict') != 1) {		
			break;
		}	
		event::add('jeedom::alert', array(
			'level' => 'danger',
...
//$deamonRunning = false;
//$deamonRunning = rpict::deamonRunning();
?>
	...
	<div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
		...
		<div class="eqLogicThumbnailContainer">
			...
			<div class="cursor" id="bt_info_daemon" style="background-color : #ffffff; height : 140px;margin-bottom : 10px;padding : 5px;border-radius: 2px;width : 160px;margin-left : 10px;" >
			  ...
			  <span style="font-size : 1.1em;position:relative; top : 23px;word-break: break-all;white-space: pre-wrap;word-wrap: break-word;color:#767676"><center>{{Info Lien}}</center></span>
			</div>
        ...
        <legend>{{Mes Modules RPICT}}</legend>
        <?php
        /*if (count($eqLogics) == 0) {
            ...
            <div class="eqLogicThumbnailContainer">
                ...
                //     echo "<center>";
                //     echo '<img src="plugins/rpict/docs/images/rpict_icon.png" height="105" width="95" />';
                //     echo "</center>";
          ...
          <div class="col-lg-6">
              <form class="form-horizontal">
                  <fieldset>
                      ...
                      <div class="form-group">
                          <label class="col-lg-4 control-label">{{Identifiant RPICT}} :</label>
                          <div class="col-lg-4">
                              <input type="text" class="eqLogicAttr form-control tooltips" title="{{Identifiant de la carte RPICT aussi connu sous NodeID.}}" data-l1key="logicalId" placeholder="{{NodeID de la carte}}"/>
                          </div>
                          <div class="col-lg-4">
                          </div>
                      </div>
              ...
              <form class="form-horizontal">
                  <fieldset>
                      ...
                      <div class="form-group">
                          ...
                          <a class="btn btn-info btn-sm eqLogicAction tooltips"  id="create_data_rpict" title="{{Permet de créer automatiquement les commandes nécessaires.}}" id="createcmd"><i class="fa fa-plus-circle"></i> {{Créer}}</a><br/><br/>
                          </div>-->
                      </div>
                      <div class="form-group">
                          ...
                          <div class="col-lg-3">
                              <a class="btn btn-info tooltips"  id="bt_rpictHealth"><i class="fa fa-medkit"></i>{{ Santé}}</a>
                          </div>
                          <div class="col-lg-6">
                          </div>
                          <!--<div class="col-md-2">
...
<?php include_file('desktop', 'rpict', 'js', 'rpict'); ?>
<?php include_file('desktop', 'rpict', 'css', 'rpict'); ?>
