...
<div class="container-modal">
    ...
    <form role="form" action="" method="post">
        ...
        <div class="row setup-content" id="step-2">
            <div class="col-xs-8 col-md-offset-3">
                <div class="col-md-10">
                    <center><h3>{{RPICT connecté}}</h3></center></br>
                    <div class="form-group">
                        <div class="row">
                        ...
                        <div class="row" style="margin-top:10px">
                        	<center><span class="advise2" style="display:none">{{Vérifier la connexion du RPICT à Jeedom}}</span></center>
                        </div>
                        <br>
                    </div>
                    <div style="background-color: #ccc;height:2px;margin-bottom:5px"></div>
        ...
        <div class="row setup-content" id="step-3">
            <div class="col-xs-8 col-md-offset-3">
                <div class="col-md-10">
                    <center><h3>{{Accès au RPICT}}</h3></center></br>
                    <div class="form-group">
                        <div class="row">
                        ...
                        <div class="row" style="margin-top:10px">
                        	<center><span class="advise3" style="display:none">{{Vérifier les droits sur le port de la laison série}}</span></center>
                        </div>
                        <br>
                    </div>
                    <div style="background-color: #ccc;height:2px;margin-bottom:5px"></div>
...
<?php include_file('desktop', 'diagnostic', 'js', 'rpict');?>
<?php include_file('desktop', 'diagnostic', 'css', 'rpict');?>
